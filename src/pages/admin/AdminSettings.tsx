...
const AdminSettings = () => {
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-10">
      ...
      <Tabs defaultValue="geral" orientation="vertical" className="flex flex-col md:flex-row gap-8 w-full">
        
        {/* SUBMENU LATERAL ESQUERDO */}
        <TabsList className="flex flex-col h-auto w-full md:w-64 bg-transparent p-0 space-y-2 shrink-0">
          <TabsTrigger 
            value="geral" 
            className="w-full justify-start px-5 py-4 rounded-2xl font-bold text-sm data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:shadow-sm text-slate-500 hover:bg-slate-200/50 transition-all"
          >
            <AppWindow size={18} className="mr-3" /> Informações Gerais
          </TabsTrigger>
          <TabsTrigger 
            value="regras" 
            className="w-full justify-start px-5 py-4 rounded-2xl font-bold text-sm data-[state=active]:bg-white data-[state=active]:text-orange-600 data-[state=active]:shadow-sm text-slate-500 hover:bg-slate-200/50 transition-all"
          >
            <Gavel size={18} className="mr-3" /> Regras de Leilão
          </TabsTrigger>
          <TabsTrigger 
            value="seguranca" 
            className="w-full justify-start px-5 py-4 rounded-2xl font-bold text-sm data-[state=active]:bg-white data-[state=active]:text-emerald-600 data-[state=active]:shadow-sm text-slate-500 hover:bg-slate-200/50 transition-all"
          >
        ...
        <div className="flex-1">
          ...
          <TabsContent value="geral" className="mt-0 space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <TabsContent value="regras" className="mt-0 space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 space-y-6">
          ...
          <TabsContent value="seguranca" className="mt-0 space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
