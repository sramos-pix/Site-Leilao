                  ...
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      {paid ? (
                        ...
                        <Badge className="bg-orange-100 text-orange-700 border-none font-black px-4 py-1 rounded-full text-[10px] tracking-widest">
                          PENDENTE
                        </Badge>
                      )}
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-end sm:items-center mt-6 gap-4">
                    ...
                    <div className="flex gap-3 w-full sm:w-auto">
                      ...
                      {paid ? (
                        <Button
                          disabled
                          className="flex-1 sm:flex-none bg-emerald-600 text-white rounded-xl font-black px-8 opacity-90 cursor-default"
                        >
                          PAGO
                        </Button>
                      ) : (
